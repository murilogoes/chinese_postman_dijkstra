...
luan1 = [(0, 1, 4, True), (0, 2, 7), (1, 0, 8, True), (1, 2, 5, True), (2, 0, 7)]

luan2 = [(0, 1, 3, True), (0, 3, 4), (1, 0, 1, True), (1, 2, 2), (3, 2, 2)]

luan3 = [(0, 1, 4), (0, 2, 8), (0, 3, 5, True), (1, 0, 4), (1, 4, 3), (2, 0, 8),
                 (2, 4, 1, True), (3, 4, 2, True), (4, 1, 3)]

luan4 = [(0, 2, 3, True), (0, 3, 4, True), (1, 0, 2, True), (2, 1, 1, True), (2, 3, 5),
                 (3, 2, 5), (3, 4, 6, True), (4, 0, 2, True)]

luan5 = [(0, 1, 1), (0, 3, 2), (1, 0, 1), (1, 3, 2, True), (1, 5, 3),
(2, 1, 2, True), (3, 0, 2), (3, 4, 1, True), (4, 5, 1, True), (5, 1, 3), (5, 2, 4, True)]

luan6 = [(0, 2, 7, True), (1, 0, 6, True), (1, 2, 6), (1, 6, 5), (2, 1, 6),
                 (2, 3, 5), (3, 2, 5), (3, 4, 5, True), (4, 1, 4, True), (4, 5, 5),
